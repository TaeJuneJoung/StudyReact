...
`;
// 1. 생성자 방식
// const regexp = new RegExp('the', '') // 옵션 빈문자: 가장 앞에 발견된 문자, g: 전체에서 같은 문자 다, gi: 전체에서 대소문자 구별없이 다
...
- 문자열.replace(정규식, 대체문자): 일치하는 문자를 대체
  replace 메소드에서 정규식을 작성하여 사용할수도 있따.
...
console.log(str.replace(regexp, "cat")); // fox부분 cat으로 수정되어 전체 str나옴
```
...
console.log(str.match(/\.$/gi)); //$ 표시는 그 앞에 문장이 끝나는지 확인 -> null -> 맨 마지막 끝에 .이 있어야 인식됨
...
```js
console.log(str.match(/\d{3}/g)); // ['010', '123', '567', '123']
console.log(str.match(/\d{3,9}/g)); // ['010', '1234', '5678', '1234']
console.log(str.match(/\d{3,}/g)); // ['010', '1234', '5678', '1234']
console.log(str.match(/\d{1,}/g)); // ['010', '1234', '5678', '1234']
console.log(str.match(/\d+/g)); // ['010', '1234', '5678', '1234']
```
...
```js
console.log(str.match(/[a-z]+/g)); // ['theedu', 'gmail', 'com', 'ello', 'world', 'https', 'www', 'google', 'com', 'he', 'quick', 'brown', 'fox', 'jumps', 'over', 'the', 'lazy', 'dog', 'hello', 'naver', 'com', 'http', 'localhost', 'abbcccddddeeeee']

console.log(str.match(/[a-zA-Z]+/g)); // ['theedu', 'gmail', 'com', 'Hello', 'world', 'https', 'www', 'google', 'com', 'The', 'quick', 'brown', 'fox', 'jumps', 'over', 'the', 'lazy', 'dog', 'hello', 'naver', 'com', 'http', 'localhost', 'abbcccddddeeeee']

console.log(str.match(/[가-힣]{3}/g)); // ['동해물', '백두산', '마르고', '닳도로']
...
```js
console.log(str.match(/https?:\/\/(?:\w+\.?)+\/?/g)); // ['https://www.google.com', 'http://localhost']

console.log(str.match(/.+(?=과)/g)); // ['동해물']
console.log(str.match(/(?<=과).+/g)); // [' 백두산이 마르고 닳도로']
...
https://github.com/ParkYoungWoong/vanillajs-movie-app
