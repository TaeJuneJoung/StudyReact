...
export default function WelcomePage() {
  ...
  const opacitryCity = useTransform(
    scrollY,
    [0, 200, 300, 500],
    [1, 0.5, 0.5, 0]
  );
  const yHero = useTransform(scrollY, [0, 200], [0, -150]);
  const opacitryHero = useTransform(scrollY, [0, 300, 500], [1, 0.5, 0]);
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          style={{ opacity: opacitryCity, y: yCity }}
          src={cityImg}
          alt="A city skyline touched by sunlight"
          id="city-image"
        />
        <motion.img
          style={{ opacity: opacitryHero, y: yHero }}
          src={heroImg}
